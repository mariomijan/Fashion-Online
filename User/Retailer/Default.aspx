<%@ Page Title="RetailerList" Language="C#" MasterPageFile="~/User\User.Master" CodeBehind="Default.aspx.cs" Inherits="Svendeproeve.User.Retailer.Default" %>
        ...
        <asp:ListView id="ListView1" runat="server"
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>
					    <asp:HyperLink runat="server" NavigateUrl='<%# FriendlyUrl.Href("~/User/Retailer/Details", Item.RetailerID) %>' Text="Details" /> | 
					    <asp:HyperLink runat="server" NavigateUrl='<%# FriendlyUrl.Href("~/User/Retailer/Edit", Item.RetailerID) %>' Text="Edit" /> | 
                    </td>
                </tr>
            </ItemTemplate>
        </asp:ListView>
